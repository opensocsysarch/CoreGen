...
std::string PROJNAME = "TEST40";
std::string PROJROOT = "./";
std::string ARCHROOT = "./";
std::string PROJYAML = "TEST40.yaml";
...
int main( int argc, char **argv ){
  ...
  if( !Cores[0]->InsertExt( E ) ){
    std::cout << "ERROR : FAILED TO INSERT EXTENSION FOR CORE 0: " <<
      CG->GetErrStr() << std::endl;
    delete CG;
    return -1;
  }
