...
std::string PROJNAME = "TEST46";
std::string PROJROOT = "./";
std::string ARCHROOT = "./";
std::string PROJYAML = "TEST46.yaml";
...
int main( int argc, char **argv ){
  ...
  CoreGenISA *EISA = E->InsertISA( PROJNAME + ".ext.isa" );
  CoreGenReg *EREG  = E->InsertReg( PROJNAME + ".ext.reg", 0, 64 );
