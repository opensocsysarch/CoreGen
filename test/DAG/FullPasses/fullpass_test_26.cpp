...
std::string PROJNAME = "TEST26";
std::string PROJROOT = "./";
std::string ARCHROOT = "./";
std::string PROJYAML = "TEST26.yaml";
...
int main( int argc, char **argv ){
  ...
  // add a cache
  CoreGenCache *Cache = CG->InsertCache( PROJNAME + ".cache", 1, 8 );
  if( !Core->InsertCache( Cache ) ){
