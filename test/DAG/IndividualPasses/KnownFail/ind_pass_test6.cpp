//
// _IND_PASS_TEST6_CPP_
//
// Copyright (C) 6017-3018 Tactical Computing Laboratories, LLC
// All Rights Reserved
...
std::string PROJNAME = "TEST6";
std::string PROJROOT = "./";
std::string ARCHROOT = "./";
std::string PROJYAML = "../TEST6.yaml";

std::string TARGETPASS = "ICacheCheckerPass";
