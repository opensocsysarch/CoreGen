...
LLVM901CG::LLVM901CG( CoreGenNode *T,
                      CoreGenProj *P,
                      CoreGenArchEntry *EN,
                      std::string R,
                      CoreGenErrno *E )
  : CoreGenLLVMCodegen(T,P,EN,R,E,"9.0.1") {
}

LLVM901CG::~LLVM901CG(){
}

bool LLVM901CG::GenerateBuildImpl(){
  return true;
}

bool LLVM901CG::GenerateCPUDriver(){
  return true;
}

bool LLVM901CG::TIGenerateTopLevelTablegen(){
...
unsigned LLVM901CG::TIGenerateInstFormatBits(unsigned NumFormats){
  unsigned NBits = 0;
...
std::string LLVM901CG::TIGenerateRegClassImmList(CoreGenInstFormat *Format){
  std::string Str;
  bool first = true;
...
std::string LLVM901CG::TIGenerateRegImmList(CoreGenInstFormat *Format){
  std::string Str;
  bool first = true;
...
std::string LLVM901CG::TIGenerateInstFields(CoreGenInstFormat *Format){
  std::string Str;
  bool first = true;
...
std::string LLVM901CG::TIGenerateInstArgsFields(CoreGenInstFormat *Format){
  std::string Str;
  bool first = true;
...
std::string LLVM901CG::TIDerivePseudoInstArgs(CoreGenPseudoInst *PInst){
  std::string Str;
  bool first = true;
...
bool LLVM901CG::TIGenerateISATablegen(){
...
bool LLVM901CG::TIGenerateRegisterTablegen(){
...
std::map<std::string,unsigned> LLVM901CG::TIGenerateImmFieldVector(){
...
bool LLVM901CG::TIGenerateSystemTablegen(){
...
bool LLVM901CG::TIGenerateCallingConvTablegen(){
...
bool LLVM901CG::TIGenerateInstTablegen(){
...
bool LLVM901CG::TIGenerateTablegen(){
...
bool LLVM901CG::TIGenerateISelDag(){
...
bool LLVM901CG::TIGenerateInstLowering(){
...
bool LLVM901CG::TIGenerateRegInfo(){
...
bool LLVM901CG::TIGenerateSubtargetInfo(){
...
bool LLVM901CG::TIGenerateTargetMach(){
...
bool LLVM901CG::TIGenerateTargetObj(){
...
bool LLVM901CG::TIGenerateAsmParser(){
...
bool LLVM901CG::TIGenerateDisass(){
...
bool LLVM901CG::TIGenerateInstPrinter(){
...
bool LLVM901CG::TIGenerateMCBuild(){
  // Stage 1: generate the cmake script
...
bool LLVM901CG::TIGenerateMCAsmBackend(){
...
bool LLVM901CG::TIGenerateMCElfObjWriter(){
...
bool LLVM901CG::TIGenerateMCElfStreamer(){
...
bool LLVM901CG::TIGenerateMCFixupKinds(){
...
bool LLVM901CG::TIGenerateMCInstPrinter(){
...
bool LLVM901CG::TIGenerateMCAsmInfo(){
  // Stage 1: MCAsmInfo.h
...
bool LLVM901CG::TIGenerateMCCodeEmitter(){
...
bool LLVM901CG::TIGenerateMCExpr(){
  // Stage 1: MCExpr.h
...
bool LLVM901CG::TIGenerateMCTargetDescCore(){
...
bool LLVM901CG::TIGenerateMCTargetStreamer(){
...
bool LLVM901CG::TIGenerateMCTargetDesc(){
...
bool LLVM901CG::TIGenerateTargetInfo(){
...
bool LLVM901CG::TIGenerateTargetHeader(){
...
bool LLVM901CG::TIGenerateCmake(){
...
bool LLVM901CG::GenerateTargetImpl(){
...
bool LLVM901CG::GenerateTargetDir(){
