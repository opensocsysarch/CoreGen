 ...
 *
 * \brief CoreGenLLVMCodegen derived class for LLVM Version 9.0.1
 *
 */

#ifndef _LLVM901CG_H_
#define _LLVM901CG_H_

#include "CoreGen/CoreGenCodegen/CoreGenLLVMCodegen.h"

class LLVM901CG  : public CoreGenLLVMCodegen {
private:
